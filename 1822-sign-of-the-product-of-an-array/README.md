<h2><a href="https://leetcode.com/problem-list/wu8rec6i/">1822. Sign of the Product of an Array</a></h2><h3>Easy</h3><hr><p>Implement a function <code>signFunc(x)</code> that returns:</p>
